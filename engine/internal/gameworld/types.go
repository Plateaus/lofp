...
type ScriptBlock struct {
	...
	Children     []ScriptBlock  `bson:"children,omitempty" json:"children,omitempty"`
	ElseActions  []ScriptAction `bson:"elseActions,omitempty" json:"elseActions,omitempty"`
	ElseChildren []ScriptBlock  `bson:"elseChildren,omitempty" json:"elseChildren,omitempty"`

	// Preserve the original order of actions and nested IF blocks.
	Statements     []ScriptStatement `bson:"statements,omitempty" json:"statements,omitempty"`
	ElseStatements []ScriptStatement `bson:"elseStatements,omitempty" json:"elseStatements,omitempty"`
}
...
// ScriptStatement represents one ordered statement inside a script block.
// Exactly one of Action or Block will be non-nil.
